...
DirectX::XMMATRIX Camera::getViewMatrix() {
	...
	if(perspective)
		return DirectX::XMMatrixPerspectiveFovLH(fov * pi / 180.0, 16.0f / 9.0f, nearPlane, farPlane);

	return DirectX::XMMatrixOrthographicLH(viewWidth, viewHeight, farPlane, farPlane);
}
