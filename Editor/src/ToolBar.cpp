...
void ToolBar::Render() {
    ...
    if(ImGui::BeginMainMenuBar()){
        ...
        if(ImGui::BeginMenu("Windows")){
            ...
            if(ImGui::MenuItem("Viewport")) ShowViewport();
        ...
        // temp
        if(ImGui::MenuItem("Compile")) ProjectManager::Compile();
        if(ImGui::MenuItem("Play")) Editor::Play();
        if(ImGui::MenuItem("Stop")) Editor::Pause();
