...
namespace rl {
    ...
    public:
    	...
    	{
            return internal::ComponentHelper::FindActiveComponentCollection().GetComponentType<T>()->GetComponent(entity);
        }

        inline static bool HasComponent(Entity entity)
        {
            return internal::ComponentHelper::FindActiveComponentCollection().GetComponentType<T>()->HasComponent(entity);
        }
