...
Window::Window(HINSTANCE hInstance, HWND parent, std::wstring name, DWORD style, int width, int height, bool debugMode) {
	...
	wClass.lpszClassName = reinterpret_cast<LPCSTR>(name.c_str());
	
	RegisterClass(&wClass);

	// Create window
	hwnd = CreateWindow(wClass.lpszClassName, wClass.lpszClassName, style, CW_USEDEFAULT, CW_USEDEFAULT, width, height, parent, NULL, hInstance, this);
